...
import SVGPathSegPolyfill = require("./util/pathsegpolyfill");
import transformParse = require("./util/transform_parse");
import Matrix = require("./util/matrix");
...
export default class SvgParser {
  ...
  constructor() {
    ...
    SVGPathSegPolyfill(this.window); //injicera polyfillen för SvgPathSegPolyfill i "simulerat" window
  }
  ...
  load(svgString: string) {
    ...
    let svg = this.window.document.body.appendChild(div).innerHTML;
